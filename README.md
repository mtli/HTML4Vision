...
imagetable(
    ...
    # modifiers
    pathrep=None, sortcol=None, precompute_thumbs=False,
    # style
...
- [precomputed thumbnails](#precomputed-thumbnails): `thumbs_dir`, `precompute_thumbs`.
...
The default thumbnail previews are based on using Javascript to resize down the image inside the browser. However, if the amount of image data is too much then this mode can become prohibitely slow or even crash in the browser, due to the system memory resources being exhausted.
